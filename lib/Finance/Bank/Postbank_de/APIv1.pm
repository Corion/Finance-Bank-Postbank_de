...
has certificate_subject => (
    ...
    default => sub {
        +{
            ...
            #                                              /businessCategory=Private Organization/jurisdictionC=DE/                                                        jurisdictionST=Hessen/                                                                                                  jurisdictionL=Frankfurt Am Main/serialNumber=HRB 30000/C=DE/ST=Hessen/L=Frankfurt am Main/O=Deutsche Bank AG/CN=bankapi-public.postbank.de
            api_public_postbank_de => qr{^/(?:\Q2.5.4.15\E|businessCategory)=Private Organization/(?:\Q1.3.6.1.4.1.311.60.2.1.3\E|jurisdictionC|jurisdictionCountryName)=DE/(?:\Q1.3.6.1.4.1.311.60.2.1.2\E|jurisdictionST|jurisdictionStateOrProvinceName)=Hessen/(?:\Q1.3.6.1.4.1.311.60.2.1.1\E|jurisdictionL|jurisdictionLocalityName)=Frankfurt [Aa]m Main/serialNumber=HRB 30000/C=DE/ST=Hessen/L=Frankfurt am Main/O=Deutsche Bank AG/CN=bankapi-public.postbank.de$}
        },
    },
);
